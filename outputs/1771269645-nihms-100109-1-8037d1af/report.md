...
- paper_id: `1771269645-nihms-100109-1-8037d1af`
- generated_at_utc: `2026-02-16T19:20:57.178645`

## Etapes
- `01` Ingestion et parsing: **completed** (6.045s) - Ingestion terminee: 34 pages, 109 passages, 1 tableaux.
- `02` Detection du design: **completed** (1.528s) - Design detecte: unknown (confiance 0.00)
- `03` Extraction des actions: **completed** (0.705s) - Actions extraites: 0 interventions, 2 comparateurs, population=parents
- `04` Extraction des outcomes: **completed** (0.640s) - Outcomes extraits: 5, confiance=0.80
- `05` Detection des effets: **completed** (1.553s) - Candidats d effet detectes: 29
- `05b` Typage des effets: **completed** (0.026s) - Candidats types: 29
- `06` Extraction effets normalises: **completed** (0.688s) - Effets bruts produits: 14 (derivables=14)
- `06b` Dedoublonnage canonique: **completed** (0.002s) - Effets canoniques: 11
- `06c` Check statistique: **completed** (0.006s) - Check statistique applique: failed=0/11
- `07` Signaux article: **completed** (0.026s) - Signaux article calcules: score=0.65
- `08` Score de biais: **completed** (0.007s) - RoB2: status=not_applicable, overall=not_applicable
- `09` Fiabilite globale: **completed** (0.005s) - Fiabilite calculee pour 11 resultats (score moyen=0.63)
...
- Effets: LLM router failed.
- Effets: llm_effects_mode=fallback_rules_after_llm_empty
