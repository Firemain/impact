...
- paper_id: `nihms-v2-rules-first-rerun`
- generated_at_utc: `2026-02-16T19:09:22.423169`

## Etapes
- `01` Ingestion et parsing: **completed** (3.501s) - Ingestion terminee: 34 pages, 109 passages, 1 tableaux.
- `02` Detection du design: **completed** (0.075s) - Design detecte: unknown (confiance 0.00)
- `03` Extraction des actions: **completed** (0.099s) - Actions extraites: 0 interventions, 2 comparateurs, population=parents
- `04` Extraction des outcomes: **completed** (0.046s) - Outcomes extraits: 5, confiance=0.80
- `05` Detection des effets: **completed** (0.102s) - Candidats d effet detectes: 35
- `05b` Typage des effets: **completed** (0.020s) - Candidats types: 35
- `06` Extraction effets normalises: **completed** (0.006s) - Effets bruts produits: 14 (derivables=14)
- `06b` Dedoublonnage canonique: **completed** (0.001s) - Effets canoniques: 11
- `06c` Check statistique: **completed** (0.005s) - Check statistique applique: failed=0/11
- `07` Signaux article: **completed** (0.021s) - Signaux article calcules: score=0.65
