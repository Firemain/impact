...
- paper_id: `nihms-v2-llm-fallback-check`
- generated_at_utc: `2026-02-16T19:10:57.284641`

## Etapes
- `01` Ingestion et parsing: **completed** (3.562s) - Ingestion terminee: 34 pages, 109 passages, 1 tableaux.
- `02` Detection du design: **completed** (2.219s) - Design detecte: unknown (confiance 0.00)
- `03` Extraction des actions: **completed** (2.154s) - Actions extraites: 0 interventions, 2 comparateurs, population=parents
- `04` Extraction des outcomes: **completed** (2.117s) - Outcomes extraits: 5, confiance=0.80
- `05` Detection des effets: **completed** (0.096s) - Candidats d effet detectes: 29
- `05b` Typage des effets: **completed** (0.019s) - Candidats types: 29
- `06` Extraction effets normalises: **completed** (2.050s) - Effets bruts produits: 14 (derivables=14)
...
- `08` Score de biais: **completed** (0.006s) - RoB2: status=not_applicable, overall=not_applicable
